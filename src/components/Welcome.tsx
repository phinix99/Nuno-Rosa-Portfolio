  ...
  return (
    <section className="w-full bg-white text-black pt-12 md:pt-16 pb-10 md:pb-14 border-b border-black/10 overflow-hidden" id="about">
      <div className="max-w-[1500px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        {/* Retail Achievements Strip - Royal Blue Background Showcase Card */}
        <motion.div 
          initial={{ opacity: 0, y: 15 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="w-full bg-[#0B3175] text-white rounded-sm md:rounded p-6 md:p-8 lg:p-10 mt-10 md:mt-14 shadow-[0_15px_40px_rgba(11,49,117,0.22)] border border-white/10 relative overflow-hidden"
        >
