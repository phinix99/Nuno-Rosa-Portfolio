    ...
    <section className="w-full bg-white text-black pt-12 md:pt-16 pb-10 md:pb-14 border-b border-black/10 overflow-hidden" id="about">
      <div className="max-w-[1500px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
          ...
          >
            <div className="text-xs md:text-sm font-bold tracking-[0.22em] uppercase text-transparent bg-clip-text bg-gradient-to-r from-[#0B3175] to-[#601DB3]">
              ABOUT ME
            </div>
            
            <h2 className="font-sans text-2xl sm:text-3xl md:text-4xl lg:text-[2.35rem] font-medium tracking-tight leading-[1.15] text-transparent bg-clip-text bg-gradient-to-r from-[#0B3175] via-[#2B1469] to-[#601DB3]">
            ...
            {/* Designer Signature Detail - Straight (not italic) with Gradient */}
            <div className="flex flex-col gap-0.5 mt-1">
              <span className="font-sans not-italic text-2xl md:text-3xl text-transparent bg-clip-text bg-gradient-to-r from-[#0B3175] to-[#601DB3] font-bold tracking-tight select-none">
                Nuno Rosa
              </span>
        ...
        >
          <div className="text-xs md:text-sm font-bold tracking-[0.22em] text-transparent bg-clip-text bg-gradient-to-r from-[#0B3175] to-[#601DB3] uppercase mb-6">
            RETAIL ACHIEVEMENTS
          </div>
            ...
            {achievements.map((item, idx) => (
              <div key={idx} className="flex flex-col gap-1.5 border-r border-[#111]/10 pr-4 last:border-r-0">
                <div className="flex items-baseline gap-0.5 text-neutral-900">
                  ...
                  {item.suffix && (
                    <span className="font-sans text-2xl lg:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#0B3175] to-[#601DB3]">
                      {item.suffix}
                    </span>
                  )}
                </div>
