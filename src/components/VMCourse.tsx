...
export default function VMCourse() {
  ...
  return (
    <section className="w-full bg-white text-black py-24 md:py-32 px-6 md:px-12 lg:px-20 border-b border-black/10 overflow-hidden" id="vm-course">
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col gap-10">
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-2">
                <span className="w-2.5 h-2.5 bg-[#7651B9] rounded-full animate-ping" />
              ...
              <p className="font-sans text-lg md:text-xl font-light text-black/70 mt-2 max-w-xl">
            ...
            <div className="flex flex-col gap-4 mt-2">
              <h3 className="font-sans text-xs font-bold tracking-widest text-black/60 uppercase">
                CURRICULUM SYLLABUS
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {modules.map((m) => (
                  <motion.div 
                    ...
                    className="p-6 bg-white border border-black/10 rounded-xl hover:border-[#7651B9]/50 hover:shadow-lg transition-all duration-300 flex flex-col gap-3 group"
                  >
                    <div className="flex justify-between items-center">
                      <span className="font-sans text-xs font-bold text-[#7651B9] tracking-widest uppercase">
                        MODULE {m.num}
                      </span>
                      <span className="w-6 h-6 rounded-full bg-white flex items-center justify-center text-xs font-semibold text-black/60 group-hover:bg-[#7651B9]/10 group-hover:text-[#7651B9] transition-colors">
                        →
                      </span>
                    </div>
                    <h4 className="font-sans text-lg font-semibold tracking-tight text-black">
                      {m.title}
                    </h4>
          ...
          <div className="lg:col-span-5 w-full lg:sticky lg:top-24 mt-4 lg:mt-0">
            <div className="w-full bg-white border border-[#7651B9]/20 rounded-2xl p-8 md:p-10 shadow-[0_12px_40px_rgba(107,76,154,0.1)] relative overflow-hidden">
              {/* Luxury Accent Bar */}
                ...
                {!submitted ? (
                  ...
                  >
                    <div className="flex flex-col gap-2">
                      <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#7651B9]/10 text-[#7651B9] rounded-full text-[10px] font-bold tracking-widest uppercase w-fit">
                        <Sparkles size={10} /> Next Cohort: Sept 2026
                      </div>
                      <h3 className="font-sans text-2xl font-bold tracking-tight text-black mt-2">
                        Reserve Your Seat
                      </h3>
                      <p className="font-sans text-xs md:text-sm font-light text-black/60 leading-relaxed">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4 font-sans">
                      <div className="flex flex-col gap-1">
                        ...
                        <input 
                          ...
                          className="w-full px-4 py-3 bg-white border border-black/10 rounded-lg focus:outline-none focus:border-[#7651B9] focus:bg-white text-sm transition-all placeholder:text-black/40 text-black"
                        />
                      </div>
                      ...
                      <button 
                        type="submit"
                        disabled={loading}
                        className="w-full mt-2 bg-[#7651B9] hover:bg-black disabled:bg-neutral-300 text-white font-bold tracking-wider uppercase text-xs py-4 rounded-lg flex items-center justify-center gap-2 transition-all duration-300 group shadow-[0_10px_30px_rgba(107,76,154,0.2)] hover:shadow-lg hover:-translate-y-0.5"
                      >
                        {loading ? (
                    ...
                    <div className="text-center font-sans text-[10px] text-black/60">
                  ...
                  >
                    ...
                    >
                      <CheckCircle2 size={56} className="text-[#7651B9] mb-6" />
                    </motion.div>
                    ...
                    <button 
                      ...
                      className="px-6 py-2 border border-black/10 hover:border-black/30 hover:bg-black/5 rounded-lg text-xs font-semibold uppercase tracking-wider text-black/80 hover:text-black transition-colors"
                    >
                      Go Back
                    </button>
                  </motion.div>
