              ...
              {modules.map((m) => (
                ...
                >
                  <div className="flex justify-between items-center">
                    <span className="font-sans text-[10px] font-bold text-[#0B3175] tracking-widest uppercase">
                      MODULE {m.num}
                    </span>
              ...
              <AnimatePresence mode="wait">
                {!submitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-3 font-sans">
                      <div className="flex flex-col gap-1">
                        ...
                        <input 
                          ...
                          className="w-full px-3.5 py-2.5 bg-white border border-black/10 rounded-sm focus:outline-none focus:border-[#0B3175] text-xs transition-all placeholder:text-black/40 text-black"
                        />
                      </div>
                      ...
                      <button 
                        type="submit"
                        disabled={loading}
                        className="w-full mt-1 bg-[#0B3175] hover:bg-black disabled:bg-neutral-300 text-white font-bold tracking-wider uppercase text-xs py-3 rounded-sm flex items-center justify-center gap-2 transition-all duration-300 group shadow-sm active:scale-[0.98]"
                      >
                        {loading ? (
                  ...
                  >
                    ...
                    >
                      <CheckCircle2 size={44} className="text-[#0B3175] mb-4" />
                    </motion.div>
