      ...
      {isVisible && (
        ...
        >
          ...
          >
            ...
            <span className="absolute -inset-1 rounded-full bg-[#7651B9]/30 blur-sm pointer-events-none group-hover:opacity-0 transition-opacity" />
          </button>
        </motion.div>
      )}
    </AnimatePresence>
