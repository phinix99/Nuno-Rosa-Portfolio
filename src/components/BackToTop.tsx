      ...
      {isVisible && (
        ...
        >
          <button
            ...
            className="group relative flex items-center gap-2 px-4 py-3 md:px-5 md:py-3.5 rounded-sm bg-[#7651B9] text-white shadow-[0_10px_30px_rgba(118,81,185,0.4)] hover:bg-black hover:shadow-[0_15px_35px_rgba(0,0,0,0.3)] transition-all duration-300 transform hover:-translate-y-1 active:scale-95 border border-white/20 backdrop-blur-md"
          >
            <div className="w-5 h-5 rounded-xs bg-white/20 flex items-center justify-center group-hover:bg-white group-hover:text-black transition-colors">
            ...
            <span className="absolute -inset-1 rounded-sm bg-[#7651B9]/30 blur-sm pointer-events-none group-hover:opacity-0 transition-opacity" />
          </button>
        </motion.div>
      )}
    </AnimatePresence>
