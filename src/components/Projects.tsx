      ...
      <div className="max-w-[1400px] mx-auto flex flex-col gap-12">
            ...
            {projects.map((proj, idx) => (
              ...
              >
                ...
                <div className="flex flex-col gap-1.5 px-1">
                  ...
                  <span className="font-sans text-[10px] font-bold tracking-widest uppercase text-[#7651B9]">{proj.category}</span>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="mt-12 md:mt-16" ref={featuredRef}>
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-neutral-950/80 via-neutral-950/20 to-transparent flex flex-col justify-end p-8 md:p-12 text-[#fdfdfd] z-10 transition-colors duration-700 group-hover:from-[#7651B9]/90 group-hover:via-[#7651B9]/20">
