    ...
    <section className="w-full bg-[#fdfdfd] pt-24 md:pt-32 pb-24 md:pb-32 border-b border-[#111]/10 px-6 md:px-12 lg:px-20" id="projects">
      <div className="max-w-[1400px] mx-auto flex flex-col gap-12">
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-1.5 text-xs font-bold tracking-widest text-[#7F56D9] uppercase">
            SELECTED WORKS
          </div>
            ...
            {projects.map((proj, idx) => (
              ...
              >
                ...
                <div className="flex flex-col gap-1.5 px-1">
                  ...
                  <span className="font-sans text-[10px] font-bold tracking-widest uppercase text-[#7F56D9]">{proj.category}</span>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="mt-12 md:mt-16" ref={featuredRef}>
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-neutral-950/80 via-neutral-950/20 to-transparent flex flex-col justify-end p-8 md:p-12 text-[#fdfdfd] z-10 transition-colors duration-700 group-hover:from-[#7F56D9]/90 group-hover:via-[#7F56D9]/20">
