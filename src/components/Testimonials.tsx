      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8 md:mb-10 border-b border-black/10 pb-4">
          ...
          <div className="flex items-center gap-2.5">
            <button 
              onClick={handlePrev}
              className="w-10 h-10 flex items-center justify-center rounded-sm bg-[#FAF9FB] border border-black/10 text-black hover:bg-[#7651B9] hover:text-white hover:border-[#7651B9] transition-all shadow-xs"
          ...
          <AnimatePresence mode="popLayout">
            {visibleTestimonials.map((t, idx) => (
              <motion.div
                ...
                className="flex flex-col justify-between p-5 md:p-6 rounded-sm md:rounded bg-[#FAF9FB] border border-black/10 hover:border-[#7651B9]/40 hover:shadow-[0_15px_30px_rgba(118,81,185,0.06)] transition-all duration-300 group min-h-[300px]"
              >
                      ...
                      <div className="relative shrink-0">
                        {t.avatar ? (
                          <img 
                            src={t.avatar} 
                            alt={t.name}
                            className="w-12 h-12 rounded-sm object-cover border border-[#7651B9] shadow-xs group-hover:scale-105 transition-transform duration-300"
                            onError={(e) => {
                        ...
                        <div className={`${t.avatar ? 'hidden' : 'flex'} w-12 h-12 rounded-sm bg-[#7651B9] text-white font-bold items-center justify-center text-sm border border-white shadow-xs`}>
