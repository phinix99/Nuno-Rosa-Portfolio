...
export default function Testimonials() {
  ...
  return (
    <section className="w-full bg-[#050505] text-[#fdfdfd] py-24 md:py-32 px-6 md:px-12 lg:px-20 border-b border-white/10 relative overflow-hidden" id="testimonials">
      ...
      <div className="max-w-[1200px] mx-auto relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-16 md:mb-24">
          ...
          <h2 className="font-sans text-4xl md:text-5xl lg:text-6xl font-medium tracking-tight uppercase text-white">
        ...
        <div className="relative w-full max-w-4xl mx-auto min-h-[300px] flex items-center justify-center">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="font-sans text-xl md:text-3xl font-light leading-relaxed text-white/90 mb-10 max-w-3xl">
                {testimonials[currentIndex].text}
              </p>
              <div className="flex flex-col items-center gap-1">
                <h4 className="font-sans text-lg font-bold tracking-tight uppercase text-white">
          ...
          <div className="absolute top-1/2 -translate-y-1/2 -left-4 md:-left-12 flex flex-col gap-4">
            <button 
              onClick={handlePrev}
              className="w-12 h-12 flex items-center justify-center rounded-full border border-white/10 text-white/50 hover:text-white hover:bg-white/5 transition-all"
            >
              <ChevronLeft size={20} />
            </button>
          </div>
        ...
        <div className="flex justify-center gap-3 mt-12">
          {testimonials.map((_, idx) => (
            <button
              ...
              className={`w-2 h-2 rounded-full transition-all duration-300 ${idx === currentIndex ? 'bg-[#6B4C9A] w-6' : 'bg-white/20 hover:bg-white/40'}`}
            />
          ))}
        </div>
